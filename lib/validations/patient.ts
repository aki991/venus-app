...
// Autoritativna šema (server) — validira ono što stiže server akciji.
...
// IZMENA: broj kartona je trajni identifikator i OBAVEZAN je u editu — prazno
// polje je validaciona greška (nikad se ne dodeljuje novi broj kroz izmenu).
// CREATE i dalje koristi patientFormSchema (prazno = auto next_card_number).
export const patientEditFormSchema = patientFormSchema.extend({
